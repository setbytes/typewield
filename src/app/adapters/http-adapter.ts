...
export class HttpAdapter {
  static createHttpAdapter(method: Method, url: string, params: any, body: any, query: any, options: any) {
    return function (...args: Array<any>) {
      ...
      const httpRequest = HttpFactory.createHttpRequest(this._httpClient)
      return httpRequest.send({ method, url: parseUrl, data, params: queries, headers: options })
    }
  }
}
